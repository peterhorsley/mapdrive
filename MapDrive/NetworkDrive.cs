...
namespace MapDrives
{
    ...
    public class NetworkDrive
    {
        ...
        {
			ConnectDialog(IntPtr.Zero);
        }

        /// <summary>
        /// Displays the standard Network drive Connection dialog. Modal.
        /// </summary>
        /// <param name="owner">The dialog's owner (window handle)</param>
        public static void ConnectDialog(IntPtr owner)
        {
            int i = WNetConnectionDialog(owner, RESOURCETYPE.DISK);
            if (i > 0) { throw new System.ComponentModel.Win32Exception(i); }
        }
        ...
        public static void DisconnectDialog(IntPtr owner)
        {
            int i = WNetDisconnectDialog(owner, RESOURCETYPE.DISK);
            if (i > 0) { throw new System.ComponentModel.Win32Exception(i); }
        }
        ...
        public static bool IsNetworkDriveOnline(string driveRoot, int timeout)
        {
            try
            {
                string uncPath = DarkGray.Net.WNet.GetRemoteUniversalName(driveRoot).UniversalName;
